...
syn keyword	splType           uint8 int8 uint16 int16 uint32 int32 uint64 int64 float32 float64 decimal32 decimal64 decimal128 complex32 complex64 tuple boolean void timestamp rstring ustring map list set enum blob xml expression operator
